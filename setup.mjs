  ...
  return (
    <nav style={{
      ...
      <ul style={{ listStyle: 'none', padding: 0, flex: 1 }}>
        ...
        <li style={{ marginBottom: '1rem' }}>
          <Link href="/forms" style={{ color: 'white', textDecoration: 'none' }}>
            📋 Formulários
          </Link>
        </li>
        <li style={{ marginBottom: '1rem' }}>
          <Link href="/teams" style={{ color: 'white', textDecoration: 'none' }}>
            👥 Times
          </Link>
        </li>
      </ul>
  ...
  return (
    <SessionProvider>
      <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: COLORS.gray50 }}>
        <DashboardNav />
        <main style={{ flex: 1, padding: '2rem', overflowAuto: true }}>
          {children}
        </main>
      </div>
    </SessionProvider>
